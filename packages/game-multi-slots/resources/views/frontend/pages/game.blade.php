...
@section('content')
    ...
    <div id="game_slots_container" class="game-slots-container">
		<div class="inner">
			...
			<div class="int">
				...
				<div id="game_slots_lines_btns" class="lines-btns">
					@if(config('game-multi-slots.max_lines')[$index] != 20)
		...
		<div class="preloader">
			<div>
				<img src="{{asset('images/games/slots/' . $settings->theme . '/wheelspin1.gif')}}" alt="" width="250" height="200">
	...
	<script>
		window.addEventListener("DOMContentLoaded",function(){
			window.game_slots_proto({
				...
				max_lines				: {{ config('game-multi-slots.max_lines')[$index] }},
