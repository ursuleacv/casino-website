...
class WithdrawalIsAllowed implements Rule
{
    private $user;
    ...
    {
        return $this->user->account->related(Deposit::class)->where('status', Deposit::STATUS_COMPLETED)->sum('amount') >= $this->minTotalDeposit;
    }
